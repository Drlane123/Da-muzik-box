      ...
      {open && (
        <div className="flex flex-col gap-3 mt-3">
          ...
          >
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <button
                ...
                style={{ background: '#121218', color: '#D500F9', border: '1px solid #D500F944', cursor: 'pointer' }}
              >
          ...
          <div className="grid grid-cols-3 gap-2">
            {VOICE_SWAP_STYLES.map((s) => (
              <button
                ...
                style={{
                  background: selectedStyle === s.id ? `${s.color}22` : '#121218',
                  border: '1px solid',
                  borderColor: selectedStyle === s.id ? s.color : '#1a1a24',
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2 text-xs" style={{ color: '#1a1a24' }}>
              <span>Subtle</span>
              <input
                type="range"
                min={0}
          ...
          <button
            ...
            style={{
              background: selectedStyle && hasSource && !isProcessing ? '#D500F9' : '#0d0d14',
            ...
            <div className="flex flex-col gap-3 border-t border-gray-700 pt-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  style={{
                    background: isPlaying ? '#D500F9' : '#0d0d14',
