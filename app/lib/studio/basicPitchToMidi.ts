/**
 * Note decoding helpers from Spotify basic-pitch-ts (Apache-2.0).
 * Source: https://github.com/spotify/basic-pitch-ts - Copyright 2022 Spotify AB
 * generateFileData / @tonejs/midi omitted (browser Hum Capture only).
 */
