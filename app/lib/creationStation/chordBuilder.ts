...
const MODE_TABLES: Record<ChordMode, ModeTable> = {
  ...
  minor: {
    ...
    defaultPads: [
      ...
      'i7', 'i9', 'iv7', 'iv9', 'V7', 'V9', 'V13', 'VImaj7', 'VImaj9', 'VII7',
      'bVII', 'bVI', 'bVImaj7', 'bIIImaj7', 'bIIImaj9', 'iiø7',
    ],
    defaultStart: 'i',
  },
  ...
  dorian: {
    ...
    defaultPads: [
      ...
      'i7', 'i9', 'ii7', 'ii9', 'IV7', 'IV9', 'IV13', 'bIIImaj7', 'bIIImaj9', 'bVIImaj7', 'bVIImaj9',
    ],
    defaultStart: 'i',
  },
