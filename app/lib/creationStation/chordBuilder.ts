...
import { RICH_JAZZ_GENRES } from '@/app/lib/creationStation/richJazzChordProgressions';
import { DEEP_NEO_GENRES } from '@/app/lib/creationStation/deepNeoChordProgressions';
...
const MODE_TABLES: Record<ChordMode, ModeTable> = {
  ...
  major: {
    semitones: {
      ...
      Imaj7:  [0, 4, 7, 11],
      Imaj9:  [0, 4, 7, 11, 14],
      /** Open neo-soul maj13 — root · 3 · 7 · 9 · 13 (no 5th). */
      Imaj13: [0, 4, 11, 14, 21],
      /** Classic Rhodes 6/9. */
      I69:    [0, 4, 7, 9, 14],
      /** Lydian maj7♯11 color. */
      'Imaj7#11': [0, 4, 7, 11, 18],
      I7:     [0, 4, 7, 10],
      ii7:    [2, 5, 9, 12],
      ii9:    [2, 5, 9, 12, 16],
      ii11:   [2, 5, 9, 12, 16, 19],
      iii7:   [4, 7, 11, 14],
      iii9:   [4, 7, 11, 14, 18],
      iii11:  [4, 7, 11, 14, 18, 21],
      IV7:    [5, 9, 12, 15],
      IVmaj7: [5, 9, 12, 16],
      IVmaj9: [5, 9, 12, 16, 19],
      IVmaj13:[5, 9, 16, 19, 26],
      IV69:   [5, 9, 12, 14, 19],
      V7:     [7, 11, 14, 17],
      V9:     [7, 11, 14, 17, 21],
      V13:    [7, 11, 14, 17, 21, 28],
      V11:    [7, 12, 14, 17, 21, 24],
      vi7:    [9, 12, 16, 19],
      vi9:    [9, 12, 16, 19, 23],
      vi11:   [9, 12, 16, 19, 23, 26],
      iiø7:   [2, 5, 8, 12],
      bVI:    [8, 12, 15],
      bVII:   [10, 14, 17],
      bIII:   [3, 7, 10],
      bIIImaj7: [3, 7, 10, 14],
      bIIImaj9: [3, 7, 10, 14, 17],
      bVImaj7: [8, 12, 15, 19],
      bVImaj9: [8, 12, 15, 19, 22],
      bVIImaj7: [10, 14, 17, 21],
      bVIImaj9: [10, 14, 17, 21, 24],
      bIImaj7: [1, 5, 8, 12],
      Isus4:  [0, 5, 7],
      Vsus4:  [7, 12, 14],
      V13sus: [7, 12, 14, 17, 21, 28],
      /** Borrowed minor iv — gospel / pop back-door cadence. */
      iv:     [5, 8, 12],
      iv9:    [5, 8, 12, 15, 19],
      iv11:   [5, 8, 12, 15, 19, 22],
    },
    info: {
      ...
      'Imaj9':  { interval: 0,  quality: 'maj9' },
      'Imaj13': { interval: 0,  quality: 'maj13' },
      'I69':    { interval: 0,  quality: '6/9' },
      'Imaj7#11': { interval: 0, quality: 'maj7#11' },
      'I7':     { interval: 0,  quality: '7' },
      'ii7':    { interval: 2,  quality: 'm7' },
      'ii9':    { interval: 2,  quality: 'm9' },
      'ii11':   { interval: 2,  quality: 'm11' },
      'iii7':   { interval: 4,  quality: 'm7' },
      'iii9':   { interval: 4,  quality: 'm9' },
      'iii11':  { interval: 4,  quality: 'm11' },
      'IV7':    { interval: 5,  quality: '7' },
      'IVmaj7': { interval: 5,  quality: 'maj7' },
      'IVmaj9': { interval: 5,  quality: 'maj9' },
      'IVmaj13':{ interval: 5,  quality: 'maj13' },
      'IV69':   { interval: 5,  quality: '6/9' },
      'V7':     { interval: 7,  quality: '7' },
      'V9':     { interval: 7,  quality: '9' },
      'V13':    { interval: 7,  quality: '13' },
      'V11':    { interval: 7,  quality: '11' },
      'vi7':    { interval: 9,  quality: 'm7' },
      'vi9':    { interval: 9,  quality: 'm9' },
      'vi11':   { interval: 9,  quality: 'm11' },
      'iiø7':   { interval: 2,  quality: 'ø7' },
      'bIII':   { interval: 3,  quality: '' },
      'bIIImaj7': { interval: 3, quality: 'maj7' },
      'bIIImaj9': { interval: 3, quality: 'maj9' },
      'bVI':    { interval: 8,  quality: '' },
      'bVImaj7': { interval: 8, quality: 'maj7' },
      'bVImaj9': { interval: 8, quality: 'maj9' },
      'bVII':   { interval: 10, quality: '' },
      'bVIImaj7': { interval: 10, quality: 'maj7' },
      'bVIImaj9': { interval: 10, quality: 'maj9' },
      'bIImaj7': { interval: 1, quality: 'maj7' },
      'Isus4':  { interval: 0,  quality: 'sus4' },
      'Vsus4':  { interval: 7,  quality: 'sus4' },
      'V13sus': { interval: 7,  quality: '13sus' },
      'iv':     { interval: 5,  quality: 'm' },
      'iv9':    { interval: 5,  quality: 'm9' },
      'iv11':   { interval: 5,  quality: 'm11' },
    },
    defaultPads: [
      'I', 'ii', 'iii', 'IV', 'V', 'vi', 'vii°',
      'Imaj7', 'Imaj9', 'Imaj13', 'I69', 'Imaj7#11',
      'ii7', 'ii9', 'ii11', 'iii7', 'iii9', 'iii11',
      'IV7', 'IVmaj7', 'IVmaj9', 'IVmaj13', 'IV69',
      'V7', 'V9', 'V11', 'V13', 'vi7', 'vi9', 'vi11',
      'bIII', 'bIIImaj7', 'bIIImaj9', 'bVI', 'bVImaj7', 'bVImaj9',
      'bVII', 'bVIImaj7', 'bVIImaj9', 'bIImaj7',
      'Isus4', 'Vsus4', 'V13sus', 'iv', 'iv9', 'iv11',
    ],
    defaultStart: 'I',
  },
  ...
  minor: {
    ...
    info: {
      ...
      'i9':     { interval: 0,  quality: 'm9' },
      'i11':    { interval: 0,  quality: 'm11' },
      'i69':    { interval: 0,  quality: 'm6/9' },
      'I7':     { interval: 0,  quality: '7' },
      ...
      'VImaj9': { interval: 8,  quality: 'maj9' },
    ...
    defaultPads: [
      ...
      'i7', 'i9', 'i11', 'i69', 'iv7', 'iv9', 'iv11',
      'V7', 'V9', 'V13', 'V13sus', 'VImaj7', 'VImaj9', 'VII7',
      'bVII', 'bVI', 'bVImaj7', 'bVImaj9', 'bIIImaj7', 'bIIImaj9', 'iiø7',
    ],
    defaultStart: 'i',
  },
  ...
  dorian: {
    ...
    info: {
      ...
      'ii11':     { interval: 2,  quality: 'm11' },
      'IV7':      { interval: 5,  quality: '7' },
      'IV9':      { interval: 5,  quality: '9' },
      'IV13':     { interval: 5,  quality: '13' },
      'IV69':     { interval: 5,  quality: '6/9' },
      'bIIImaj7': { interval: 3,  quality: 'maj7' },
      'bIIImaj9': { interval: 3,  quality: 'maj9' },
      'bVIImaj7': { interval: 10, quality: 'maj7' },
    ...
    defaultPads: [
      ...
      'i7', 'i9', 'i11', 'i69', 'ii7', 'ii9', 'ii11',
      'IV7', 'IV9', 'IV13', 'IV69', 'bIIImaj7', 'bIIImaj9', 'bVIImaj7', 'bVIImaj9',
    ],
    defaultStart: 'i',
  },
