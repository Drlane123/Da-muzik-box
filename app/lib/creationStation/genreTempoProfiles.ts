...
export const GENRE_TEMPO_PROFILES: Record<string, GenreTempoProfile> = {
  ...
  'rich-jazz': { min: 68, max: 132, recommended: 92, note: 'Rich Jazz · Neo · 70s soul jazz pocket' },
  'deep-neo': { min: 66, max: 96, recommended: 78, note: 'Deep Neo · lush maj13 / 6/9 / m11 colors' },
...
const PROGRESSION_TEMPO_OVERRIDES: Record<string, number> = {
  ...
  'deep-rnb::deeprnb-lush-ninth-vamp': 68,
  'deep-rnb::deeprnb-quiet-storm-maj9': 66,
  'deep-rnb::deeprnb-glasper-cycle': 70,
  'deep-rnb::deeprnb-min-smoky-m9': 64,
  'deep-rnb::deeprnb-min-midnight': 66,
  'deep-rnb::deeprnb-candle-glow': 72,
  'rich-jazz::rjazz-lush-251': 96,
  'rich-jazz::rjazz-ballad-mist': 72,
  'rich-jazz::rjazz-70s-velvet': 88,
  'rich-jazz::rjazz-neo-modal': 84,
  'rich-jazz::rjazz-dark-smoke': 78,
  'rich-jazz::rjazz-gospel-lift': 92,
