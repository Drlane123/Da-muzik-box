...
export type GrooveLabLayerId = 'sub' | 'chord' | 'melody';
...
const LAYER_ROWS: ReadonlyArray<{
  ...
  { id: 'sub', label: 'SUB', color: '#93c5fd' },
  { id: 'chord', label: 'CHORD', color: '#86efac' },
  { id: 'melody', label: 'MELODY', color: '#fbbf24' },
];
