...
export function Se2HumCaptureCollapsedStrip({
  ...
  return (
    <button
      ...
      title="Show Hum Capture — mic, key pads, melody roll"
      aria-expanded={false}
      aria-label="Expand Hum Capture panel"
    >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="truncate">{trackName} — Hum Capture</span>
        ...
        <button
          ...
          title="Collapse Hum Capture — click the arrow bar to expand again"
        >
